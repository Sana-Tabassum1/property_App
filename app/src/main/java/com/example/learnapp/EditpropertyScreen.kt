...
class EditpropertyScreen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // val itemToEdit = intent.getParcelableExtra<propertyEntitiy>("property_entity")

//        if (itemToEdit != null) {
//            // Populate your UI elements with itemToEdit's properties
//            binding.Editroom.setText(itemToEdit.room)
//            binding.Editbedroom.setText(itemToEdit.bedrooms)
//            binding.Editbathroom.setText(itemToEdit.bathrooms)
//            binding.Editfloor.setText(itemToEdit.floor)
//            binding.Editarea.setText(itemToEdit.Area)
//            binding.Editlocation.setText(itemToEdit.location)
//
//            // Set the selected radio button based on the itemToEdit's type
//            when (itemToEdit.type) {
//                "Rent" -> binding.rent.isChecked = true
//                "Sale" -> binding.sale.isChecked = true
//            }
//
//            // Set the selected radio button based on the itemToEdit's interior type
//            when (itemToEdit.interior) {
//                "furnitured" -> binding.furnitured.isChecked = true
//                "nonfurnitured" -> binding.nonfurnitured.isChecked = true
//            }
